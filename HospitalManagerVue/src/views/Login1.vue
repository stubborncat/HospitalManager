      ...
      >
        ...
        <el-form-item class="role" style="margin-left: 10px;">
          <el-radio-group v-model="role" size="small" style="display: flex;">
            <el-radio label="药库"></el-radio>
            <el-radio label="医疗库"></el-radio>
      ...
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          if (this.role === "药库") {
            ...
            params3.append("phId", this.loginForm.id);
            params3.append("phPassword", this.loginForm.password);

            request
              .post("pharmacy/login", params3)
              .then((res) => {
                console.log(res);
                if (res.data.status != 200)
                  return this.$message.error(
                ...
                setToken(res.data.data.token);
                this.$router.push("/pharmacyLayout");
              })
              .catch((e) => {
                console.log(e);
                if (
          ...
          if (this.role === "医疗库") {
            ...
            params4.append("eId", this.loginForm.id);
            params4.append("ePassword", this.loginForm.password);

            request
              .post("equipment/login", params4)
              .then((res) => {
                console.log(res);
                if (res.data.status != 200)
                  return this.$message.error(
                ...
                setToken(res.data.data.token);
                this.$router.push("/equipmentLayout");
              })
              .catch((e) => {
                console.log(e);
                if (
