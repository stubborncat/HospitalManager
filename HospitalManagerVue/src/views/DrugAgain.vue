<template>
  <el-container>
    ...
    <el-header>
      <div class="words">
                <span @click="menuClick('pharmacyLayout')">
    ...
    <el-container>
      ...
      <el-aside width="200px">
        ...
        >
          <el-menu-item
            index="drugAgainLayout"
            @click="menuClick('drugAgainLayout')"
          ...
          <el-menu-item
            ...
            @click="menuClick('departmentListN')"
            style="font-size: 20px"
          >
            <i
              class="iconfont icon-r-paper"
...
export default {
  ...
  methods: {
    ...
    menuClick(path) {
      ...
      if (this.$route.path !== "/" + path) this.$router.push('/drugAgain/'+path);
      console.log(path);
    },
    //退出登录
    logout() {
